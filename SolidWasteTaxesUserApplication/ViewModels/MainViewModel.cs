...
namespace SolidWasteTaxesUserApplication.ViewModels
{
    ...
    //{
    //    private MainModel _startPageModel;
    //    public MainViewModel()
    //    {
    //        _startPageModel = new MainModel();
    //        _startPageModel.SettingsViewVisible = false;
    //        _startPageModel.SpecificWasteViewVisible = false;
    //        _startPageModel.TaxesInformationViewVisible = false;
    //    }
